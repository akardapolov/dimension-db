...
@Disabled
public class DBaseDuckDBPercentileTest extends AbstractBackendSQLTest {

  private static final long MINUTE_MS = 60_000L;

  private final String dbUrl = "jdbc:duckdb::memory:percentile-testdb";
  private final String driverClassName = "org.duckdb.DuckDBDriver";
  private final String tableName = "duckdb_percentile_data";
  ...
  public void setUp() throws SQLException, TableNameEmptyException {
    ...
    try (Connection conn = ds.getConnection(); Statement st = conn.createStatement()) {
      ...
      st.executeUpdate("CREATE TABLE " + tableName +
          " (ts TIMESTAMP, long_field BIGINT, string_field VARCHAR)");
    }
