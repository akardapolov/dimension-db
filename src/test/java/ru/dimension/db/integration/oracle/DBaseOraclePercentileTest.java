...
@Disabled
public class DBaseOraclePercentileTest extends AbstractBackendSQLTest {

  private static final long MINUTE_MS = 60_000L;

  private final String dbUrl = "jdbc:oracle:thin:@localhost:1523:orcl";
  private final String driverClassName = "oracle.jdbc.driver.OracleDriver";
  private final String tableName = "ORACLE_PERCENTILE_DATA";
  ...
  public void setUp() throws SQLException, TableNameEmptyException {
    ...
    this.ds = getDatasource(bType, driverClassName, dbUrl, "system", "sys");
    ...
    try (Connection conn = ds.getConnection(); Statement st = conn.createStatement()) {
      ...
      st.executeUpdate("CREATE TABLE " + tableName +
          " (ts TIMESTAMP, long_field NUMBER(19), string_field VARCHAR2(10))");
    }
