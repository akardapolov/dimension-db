...
@Disabled
public class DBaseMySQLPercentileTest extends AbstractBackendSQLTest {

  private static final long MINUTE_MS = 60_000L;

  private final String dbUrl = "jdbc:mysql://localhost:3307/dimension-db?createDatabaseIfNotExist=true";
  private final String driverClassName = "com.mysql.cj.jdbc.Driver";
  private final String tableName = "mysql_percentile_data";
  ...
  public void setUp() throws SQLException, TableNameEmptyException {
    ...
    this.ds = getDatasource(bType, driverClassName, dbUrl, "root", "root");

    try (Connection conn = ds.getConnection(); Statement st = conn.createStatement()) {
      st.executeUpdate("DROP TABLE IF EXISTS " + tableName);
      st.executeUpdate("CREATE TABLE " + tableName +
          " (ts DATETIME(3), long_field BIGINT, string_field VARCHAR(10))");
    }
