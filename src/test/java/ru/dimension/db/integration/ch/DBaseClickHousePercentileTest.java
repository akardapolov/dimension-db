...
@Disabled
public class DBaseClickHousePercentileTest extends AbstractBackendSQLTest {
  ...
  private final String tableName = "default.ch_percentile_data";
  ...
  public void setUp() throws SQLException, TableNameEmptyException {
    ...
    this.ds = getDatasource(bType, driverClassName, dbUrl, "admin", "admin");

    try (Connection conn = ds.getConnection(); Statement st = conn.createStatement()) {
      st.executeUpdate("DROP TABLE IF EXISTS " + tableName);
      st.executeUpdate(
          "CREATE TABLE " + tableName +
              " (ts DateTime, long_field Int64, string_field String)" +
