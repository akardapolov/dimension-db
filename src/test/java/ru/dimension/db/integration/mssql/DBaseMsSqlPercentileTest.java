...
@Disabled
public class DBaseMsSqlPercentileTest extends AbstractBackendSQLTest {
  ...
  private final String tableName = "dbo.mssql_percentile_data";
  ...
  public void setUp() throws SQLException, TableNameEmptyException {
    ...
    this.ds = getDatasource(bType, driverClassName, dbUrl, "sa", "QOEfSsa51234!");

    try (Connection conn = ds.getConnection(); Statement st = conn.createStatement()) {
      st.executeUpdate("IF OBJECT_ID('" + tableName + "', 'U') IS NOT NULL DROP TABLE " + tableName);
      st.executeUpdate("CREATE TABLE " + tableName +
          " (ts DATETIME2, long_field BIGINT, string_field NVARCHAR(10))");
    }
