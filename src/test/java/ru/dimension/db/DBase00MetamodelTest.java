...
public class DBase00MetamodelTest {
  ...
  public void metaModelSaveUpdateTest() throws IOException, ClassNotFoundException {
    ...
    DBaseConfig dBaseConfig = new DBaseConfig();
    dBaseConfig.setConfigDirectory(absPath);
    dBaseConfig.setConfigFileName("metamodel.obj");

    // save
    FileConfig fileConfig = new FileConfig(dBaseConfig);
