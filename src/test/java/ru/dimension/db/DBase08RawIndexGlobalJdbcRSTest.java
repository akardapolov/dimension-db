...
@Log4j2
public class DBase08RawIndexGlobalJdbcRSTest extends AbstractH2Test {
  ...
  private List<List<Object>> RSTest(int begin, int end, int fetchSize) {
    BatchResultSet batchResultSet = dStore.getBatchResultSet(tableName, begin, end, fetchSize);
