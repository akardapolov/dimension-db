...
public class FileConfig {
  ...
  public FileConfig(DBaseConfig dBaseConfig) {
  ...
  private String getPathName() {
    Path resourceDirectory = Paths.get(dBaseConfig.getConfigDirectory());
    String absolutePath = resourceDirectory.toFile().getAbsolutePath();
    return absolutePath + FILE_SEPARATOR + dBaseConfig.getConfigFileName();
  }
}
